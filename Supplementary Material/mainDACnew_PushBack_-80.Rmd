...
p2 <- plotProbabilisticFeasibilitySpace(
  ...
  colour = colours[1],
  marginal.year = 2047,
  title = "North America, -80% Capacity"
)
...
print(p)
ggsave(paste0(path.output, "FIG04_Probabilistic_Feasibility_Space_Conventional_-80.png"),
       width = 18, height = 5, units = "cm", bg = "white")
ggsave(paste0(path.output, "FIG04_Probabilistic_Feasibility_Space_Conventional_-80.pdf"),
       width = 18, height = 5, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "FIG05_PFS_Unconventional_Standard_-80.png"),
       width = 18, height = 5, units = "cm", bg = "white")
ggsave(paste0(path.output, "FIG05_PFS_Unconventional_Standard_-80.pdf"),
       width = 18, height = 5, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "FIG06_PFS_Conservative_Standard_-80.png"),
       width = 18, height = 5, units = "cm", bg = "white")
ggsave(paste0(path.output, "FIG06_PFS_Conservative_Standard_-80.pdf"),
       width = 18, height = 5, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "FIG07_Sensitivity_Anticipation_Conventional_PushBack_-80.jpg"),
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a5_PushBack_-80.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a10_PushBack_-80.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a100_PushBack_-80.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG08_Sensitivity_Anticipation_Unconventional_PushBack_-80.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a5_PushBack_-80.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a10_PushBack_-80.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a100_PushBack_-80.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG09_Sensitivity_Anticipation_Conservative_PushBack_-80.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a5_PushBack_-80.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a10_PushBack_-80.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a100_PushBack_-80.xlsx")
```
