...
```{r, message = FALSE}
# DAC Projects Database
file.dacprojects <- paste0(path.input, "Capacity DAC Projects Database 2023_Later(5,2030).xlsx")
...
print(p)
ggsave(paste0(path.output, "FIG04_Probabilistic_Feasibility_Space_Conventional_-5.png"),
       width = 18, height = 5, units = "cm", bg = "white")
ggsave(paste0(path.output, "FIG04_Probabilistic_Feasibility_Space_Conventional_-5.pdf"),
       width = 18, height = 5, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "FIG05_PFS_Unconventional_Standard_-5_Years.png"),
       width = 18, height = 5, units = "cm", bg = "white")
ggsave(paste0(path.output, "FIG05_PFS_Unconventional_Standard_-5_Years.pdf"),
       width = 18, height = 5, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "FIG06_PFS_Conservative_Standard_-5_Years.png"),
       width = 18, height = 5, units = "cm", bg = "white")
ggsave(paste0(path.output, "FIG06_PFS_Conservative_Standard_-5_Years.pdf"),
       width = 18, height = 5, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "FIG07_Sensitivity_Anticipation_Conventional_PushBack_-5y.jpg"),
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a5_PushBack_-5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a10_PushBack_-5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a100_PushBack_-5y.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG08_Sensitivity_Anticipation_Unconventional_PushBack_-5y.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a10_PushBack_-5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a100_PushBack_-5y.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG09_Sensitivity_Anticipation_Conservative_PushBack_-5y.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a5_PushBack_-5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a10_PushBack_-5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a100_PushBack_-5y.xlsx")
```