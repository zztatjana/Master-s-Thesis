...
p2 <- plotProbabilisticFeasibilitySpace(
  ...
  colour = colours[1],
  marginal.year = 2043,
  title = "North America, +100% Capacity"
)
...
print(p)
ggsave(paste0(path.output, "FIG04_Probabilistic_Feasibility_Space_Conventional_+100.png"),
       width = 18, height = 5, units = "cm", bg = "white")
ggsave(paste0(path.output, "FIG04_Probabilistic_Feasibility_Space_Conventional_+100.pdf"),
       width = 18, height = 5, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "FIG05_PFS_Unconventional_Standard_+100.png"),
       width = 18, height = 5, units = "cm", bg = "white")
ggsave(paste0(path.output, "FIG05_PFS_Unconventional_Standard_+100.pdf"),
       width = 18, height = 5, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "FIG06_PFS_Conservative_Standard_+100.png"),
       width = 18, height = 5, units = "cm", bg = "white")
ggsave(paste0(path.output, "FIG06_PFS_Conservative_Standard_+100.pdf"),
       width = 18, height = 5, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "FIG07_Sensitivity_Anticipation_Conventional_Pull_+100.jpg"),
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a5_Pull_+100.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a10_Pull_+100.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a100_Pull_+100.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG08_Sensitivity_Anticipation_Unconventional_Pull_100.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a5_Pull_+100.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a10_Pull_+100.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a100_Pull_+100.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG09_Sensitivity_Anticipation_Conservative_Pull_+100.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a5_Pull_+100.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a10_Pull_+100.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a100_Pull_+100.xlsx")
```