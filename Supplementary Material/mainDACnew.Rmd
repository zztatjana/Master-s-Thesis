...
#Social Pull (Case 1)
data.eu.pull1 <- read_scenario_data("Social Pull Europe (Case 1)", 6)

#Social Pull (Case 2)
data.eu.pull2 <- read_scenario_data("Social Pull Europe (Case 2)", 7)

#Social Pull (Case 3)
data.eu.pull3 <- read_scenario_data("Social Pull Europe (Case 3)", 8)

#Social Push Back (Case 1)
data.eu.pushback1 <- read_scenario_data("Social PBack Europe (Case 1)", 9)

#Social Push Back  (Case 2)
data.eu.pushback2 <- read_scenario_data("Social PBack Europe (Case 2)", 10)

#Social Push Back  (Case 3)
data.eu.pushback3 <- read_scenario_data("Social PBack Europe (Case 3) ", 11)
...
data.plot.eu.pull1 <- bind_rows(data.eu.pull1)%>%
                   mutate(model = "Case 1, social pull")

data.plot.eu.pull2 <- bind_rows(data.eu.pull2)%>%
                   mutate(model = "Case 2, social pull")

data.plot.eu.pull3 <- bind_rows(data.eu.pull3)%>%
                   mutate(model = "Case 3, social pull")


data.plot.eu.pushback1 <- bind_rows(data.eu.pushback1)%>%
                   mutate(model = "Case 1, social push back")

data.plot.eu.pushback2 <- bind_rows(data.eu.pushback2)%>%
                   mutate(model = "Case 2, social push back")

data.plot.eu.pushback3 <- bind_rows(data.eu.pushback3)%>%
                   mutate(model = "Case 3, social push back")
...
data.plot.eu.social <- bind_rows(data.plot.eu.pull1,
                                  data.plot.eu.pull2,
                                  data.plot.eu.pull3,
                                  data.plot.eu.pushback1,
                                  data.plot.eu.pushback2,
                                  data.plot.eu.pushback3
                                  )
# Diffusion model
...
colours.social.eu <- c("Case 1, social pull" = colours[6],
                       "Case 2, social pull" = colours[6],
                       "Case 3, social pull" = colours[6],
                       "Case 1, social push back" = colours[7],
                       "Case 2, social push back" = colours[7], 
                       "Case 3, social push back" = colours[7]
                       )
...
data.na.pull1 <- read_scenario_data("Social Pull NA (Case 1)", 6)

#Social based Capacity (Case 2)
data.na.pull2 <- read_scenario_data("Social Pull NA (Case 2)", 7)

#Social based Capacity (Case 3)
data.na.pull3 <- read_scenario_data("Social Pull NA (Case 3)", 8)

#Social based Years (Case 1)
data.na.pushback1 <- read_scenario_data("Social PBack NA (Case 1) ", 9)

#Social based Years (Case 2)
data.na.pushback2 <- read_scenario_data("Social PBack NA (Case 2)", 10)

#Social based Years (Case 3)
data.na.pushback3 <- read_scenario_data("Social PBack NA (Case 3) ", 11)
...
data.plot.na.pull1 <- bind_rows(data.na.pull1)%>%
                   mutate(model = "Case 1, social pull")

data.plot.na.pull2 <- bind_rows(data.na.pull2)%>%
                   mutate(model = "Case 2, social pull")

data.plot.na.pull3 <- bind_rows(data.na.pull3)%>%
                   mutate(model = "Case 3, social pull")


data.plot.na.pushback1 <- bind_rows(data.na.pushback1)%>%
                   mutate(model = "Case 1, social push back")

data.plot.na.pushback2 <- bind_rows(data.na.pushback2)%>%
                   mutate(model = "Case 2, social push back")

data.plot.na.pushback3 <- bind_rows(data.na.pushback3)%>%
                   mutate(model = "Case 3, social push back")
...
# Social based Scenarios
data.plot.na.social <- bind_rows(data.plot.na.pull1,
                                  data.plot.na.pull2,
                                  data.plot.na.pull3,
                                  data.plot.na.pushback1,
                                  data.plot.na.pushback2,
                                  data.plot.na.pushback3
                                  )
...
colours.social.na <- c("Case 1, social pull" = colours[6],
                       "Case 2, social pull" = colours[6],
                       "Case 3, social pull" = colours[6],
                       "Case 1, social push back" = colours[7],
                       "Case 2, social push back" = colours[7], 
...
#Social based Capacity (Case 1)
data.glob.pull1 <- read_scenario_data("Social Pull Global (Case 1)", 6)

#Social based Capacity (Case 2)
data.glob.pull2 <- read_scenario_data("Social Pull Global (Case 2)", 7)

#Social based Capacity (Case 3)
data.glob.pull3 <- read_scenario_data("Social Pull Global (Case 3)", 8)

#Social based Years (Case 1)
data.glob.pushback1 <- read_scenario_data("Social PBack Global (Case 1)", 9)

#Social based Years (Case 2)
data.glob.pushback2 <- read_scenario_data("Social PBack Global (Case 2) ", 10)

#Social based Years (Case 3)
data.glob.pushback3 <- read_scenario_data("Social PBack Global (Case 3)", 11)
...
data.plot.glob.pull1 <- bind_rows(data.glob.pull1)%>%
                   mutate(model = "Case 1, social pull")

data.plot.glob.pull2 <- bind_rows(data.glob.pull2)%>%
                   mutate(model = "Case 2, social pull")

data.plot.glob.pull3 <- bind_rows(data.glob.pull3)%>%
                   mutate(model = "Case 3, social pull")


data.plot.glob.pushback1 <- bind_rows(data.glob.pushback1)%>%
                   mutate(model = "Case 1, social push back")

data.plot.glob.pushback2 <- bind_rows(data.glob.pushback2)%>%
                   mutate(model = "Case 2, social push back")

data.plot.glob.pushback3 <- bind_rows(data.glob.pushback3)%>%
                   mutate(model = "Case 3, social push back")
# IAM scenarios
...
# Social based Scenarios
data.plot.glob.social <- bind_rows(data.plot.glob.pull1,
                                  data.plot.glob.pull2,
                                  data.plot.glob.pull3,
                                  data.plot.glob.pushback1,
                                  data.plot.glob.pushback2,
                                  data.plot.glob.pushback3
                                  )
...
colours.social.glob <- c("Case 1, social pull" = colours[6],
                       "Case 2, social pull" = colours[6],
                       "Case 3, social pull" = colours[6],
                       "Case 1, social push back" = colours[7],
                       "Case 2, social push back" = colours[7], 
...
ggsave(paste0(path.output, "FIG10_comparison_scenarios.png"),
       width = 21, height = 20, units = "cm", bg = "transparent")
```
