...
print(p)
ggsave(paste0(path.output, "FIG07_Sensitivity_Anticipation_Conventional_PushBack_-25.jpg"),
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a5_PushBack_-25.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a10_PushBack_-25.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a100_PushBack_-25.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG08_Sensitivity_Anticipation_Unconventional_PushBack_-25.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a5_PushBack_-25.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a10_PushBack_-25.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a100_PushBack_-25.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG09_Sensitivity_Anticipation_Conservative_PushBack_-50.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
