...
```{r, message = FALSE}
# DAC Projects Database
file.dacprojects <- paste0(path.input, "Capacity DAC Projects Database 2023_Earlier(5, 2020).xlsx")
...
print(p)
ggsave(paste0(path.output, "FIG07_Sensitivity_Anticipation_Conventional_Pull_+5y.jpg"),
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a5_Pull_+5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a10_Pull_+5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conventional_a100_Pull_+5y.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG08_Sensitivity_Anticipation_Unconventional_Pull_+5y.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a5_Pull_+5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a10_Pull_+5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_unconventional_a100_Pull_+5y.xlsx")
```
...
print(p)
ggsave(paste0(path.output, "FIG09_Sensitivity_Anticipation_Conservative_Pull_+5y.jpg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a5_Pull_+5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a10_Pull_+5y.xlsx")
```
...
#write.xlsx(stats, file = "02_output_plots_new/stats_conservative_a100_Pull_+5y.xlsx")
```